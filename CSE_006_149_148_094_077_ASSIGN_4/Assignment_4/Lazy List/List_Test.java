...
public class List_Test{
	...
	{	
		...
		int number;
		int PER_THREAD_PREFILL=RANGE/100*PRE_FILL/16;
		int int_range=RANGE;
		public void run()
		{
			// Random rd1=new Random();
			for(int i=0;i<PER_THREAD_PREFILL;)
			{
				...
				if(ins){ i=i+1;  
					if(i%10000 == 0)	System.out.println("Thread no: "+number+" :i val: "+i);
				}
			}
	...
	public static void main(String[] args){
		...
		// System.out.print("Number of Threads: "+num_threads+"\nSize: "+range+"\nThroughput: "+throughput+"\n\n");	
